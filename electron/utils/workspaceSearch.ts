...
async function searchWorkspaceFiles(
  roots: string[],
  query: string,
  { limit = DEFAULT_LIMIT, depth = MAX_DEPTH }: { limit?: number; depth?: number } = {},
  ...
  const walk = async (dir: string, currentDepth: number, projectName: string): Promise<void> => {
...
export { searchWorkspaceFiles, IGNORED_DIRS, IGNORED_FILES, MAX_DEPTH, DEFAULT_LIMIT }
