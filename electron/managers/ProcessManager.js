...
const { isPortOpen } = require('../utils/portCheck')
const { killProcessTree, getProcessResources, getProcessTreeResources } = require('../utils/processTree')
const { logFilePath, appendEntry, readEntries, truncate, clear } = require('../utils/logStore')
...
class ProcessManager extends EventEmitter {
  ...
  async loadPersistedLogs(projectId, limit = null) {
    const parsed = await readEntries(this.getLogFilePath(projectId))
...
getCommandSnapshot(processData) {
  ...
  getProcessTreeResources(rootPids) {
