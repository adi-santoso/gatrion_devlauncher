...
export default function TerminalWorkspace({ projects = [], getLogs = () => [], onClearLogs, fontSize, autoScroll = true, onAutoScrollChange }: TerminalWorkspaceProps) {
