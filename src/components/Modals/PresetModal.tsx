...
/** Preset as edited by this modal — persisted fields plus optional display fields. */
export interface PresetEditData {
  id: string;
  name: string;
  projectIds?: string[];
  description?: string;
...
interface PresetModalProps {
  ...
  initialPreset?: PresetEditData | null;
...
export default function PresetModal({
  ...
  const [delaySeconds, setDelaySeconds] = useState<number | string>(0);
  ...
  const moveSelected = (id: string, direction: number): void => {
    setSelected((prev) => {
